...
INDUSTRY = {
    ...
    "relaxation": {
        "label": "リラクゼーションサロン", "main": "#00897B", "accent": "#4DB6AC", "bg": "#E8F5E9",
        "hero": "https://images.unsplash.com/photo-1600334089648-b0d9d3028eb2?w=1600&q=80",
        "headline": "がんばった一日の終わりに、\nゆっくりほぐしませんか",
        "sub": "お好みの強さをうかがいながら、ゆっくりおもてなしいたします。",
        "troubles": ["肩や首まわりが重たく感じる", "一日中座りっぱなしだった",
                     "歩きすぎて脚が張っている", "ゆっくりする時間がとれていない"],
        "services": [
            ("もみほぐし", "お好みの強さでゆっくりおほぐしします。",
             "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=800&q=80"),
            ("フットケア", "歩き疲れた脚まわりを中心におほぐしします。",
             "https://images.unsplash.com/photo-1519823551278-64ac92734fb1?w=800&q=80"),
            ("ヘッドケア", "頭から首まわりにかけてお手入れします。",
